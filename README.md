...
We compare our try-on results with the most relevant previous work (FWGAN). All of the following cases show that we synthesize sequential try-on results containing more detailed information (e.g., human information) and correct clothing shape than FWGAN.
